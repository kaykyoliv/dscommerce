...
public class UserServiceTests {
    ...
    public void authenticatedShouldReturnUserWhenUserExists(){
        Mockito.when(customUserUtil.getUserLogged()).thenReturn(existingUsername);
    ...
    public void authenticatedShouldThrowUsernameNotFoundExceptionWhenUserDoesNotExists(){
        Mockito.doThrow(ClassCastException.class).when(customUserUtil).getUserLogged();
        Assertions.assertThrows(UsernameNotFoundException.class, () -> {
    ...
    @Test
    public void getMeShouldThrowUsernameNotFoundWhenUserNotAuthenticated(){
        UserService userServiceSpy = Mockito.spy(service);
